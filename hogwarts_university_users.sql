...
CREATE TABLE `users` (
  ...
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`id_ocupacao_fk`) REFERENCES `ocupacao` (`id_ocupacao`),
  CONSTRAINT `users_ibfk_2` FOREIGN KEY (`id_acesso_FK`) REFERENCES `acesso` (`id_acesso`)
