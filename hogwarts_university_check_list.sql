...
CREATE TABLE `check_list` (
  ...
  KEY `id_itens_FK` (`id_itens_FK`),
  CONSTRAINT `check_list_ibfk_1` FOREIGN KEY (`id_local_FK`) REFERENCES `local` (`id_local`),
  CONSTRAINT `check_list_ibfk_2` FOREIGN KEY (`id_itens_FK`) REFERENCES `itens` (`id_itens`)
